...
class UnifiedStatusCast implements Cast
{
    /**
     * @param  ?string  $value  — входящее значение статуса
     * @param  CreationContext  $context  — доп. данные о том, откуда заказ?
     */
    public function cast(DataProperty $property, mixed $value, array $properties, CreationContext $context): UnifiedOrderStatus
    {
        ...
        return match ($type) {
            ...
            default => UnifiedOrderStatus::ERROR_PARSE,
        };
    }
}
