...
export const isImage = (file: Media) => file.mime_type.startsWith('image/');
export const isVideo = (file: Media) => file.mime_type.startsWith('video/');
export const isAudio = (file: Media) => file.mime_type.startsWith('audio/');
