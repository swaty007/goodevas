<template>
  <FormControl :name="name" :label="label" :error="error">
    <div
      class="relative block w-full rounded-md border bg-white dark:bg-gray-700 dark:text-gray-100 text-gray-800 shadow-sm focus-within:outline-none focus-within:ring-1"
      :class="{
    ...
    >
      <div
        v-if="!withoutToolbar"
        class="flex flex-wrap items-center gap-2 divide-x divide-gray-100 border-b border-gray-300 dark:border-gray-600 px-2 py-1.5"
      >
