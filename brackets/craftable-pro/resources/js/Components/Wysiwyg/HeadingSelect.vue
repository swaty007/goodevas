<template>
  <Listbox as="div" v-model="selectedTextStyle">
    <div class="relative" v-auto-animate>
      <ListboxButton
        class="relative w-32 cursor-pointer rounded-md bg-white dark:bg-gray-700 py-1.5 pl-2 pr-6 text-left font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none sm:text-sm"
      >
      ...
      <ListboxOptions
        class="absolute z-10 mt-1 max-h-60 w-40 overflow-auto rounded-md bg-white dark:bg-gray-700 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
      >
        <ListboxOption
          as="template"
