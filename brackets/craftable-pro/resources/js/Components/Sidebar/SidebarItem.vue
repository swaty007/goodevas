<template>
    <Link
        ...
        :class="[
            active
                ? 'bg-primary-100 text-gray-900 dark:bg-primary-800 dark:text-gray-100'
        ...
        <component
            ...
            :class="[
                active
                    ...
                    : 'text-gray-400 group-hover/link:text-gray-500 dark:text-gray-500 dark:group-hover/link:text-gray-300',
...
const active = computed(() => {
  ...
  return props.href.indexOf(url) !== -1;
});
</script>
