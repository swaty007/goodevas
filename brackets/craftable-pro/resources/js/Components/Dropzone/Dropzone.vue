<template>
    <div class="w-full">
        ...
        <div
            v-auto-animate
            class="mt-1 rounded-md shadow-sm sm:col-span-2 sm:mt-0"
        >
            <div
                v-if="filteredFiles.length"
                class="rounded-md border border-gray-300 dark:border-gray-500"
                :class="{
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <button
                            type="button"
                            class="text-danger-500 hover:text-danger-700 absolute -top-2 -right-2 rounded-full bg-white dark:bg-gray-700"
                ...
                <div
                    v-else
                    v-auto-animate
                    class="divide-y divide-gray-100 border-gray-300 dark:border-gray-500"
                >
                    <div
                        v-for="file in filteredFiles"
                        :key="file.uuid"
                    ...
                    >
                            ...
                            >
                                ...
                                >
                                    <Button
                                        ...
                                        color="gray"
                                        variant="outline"
                                    >{{ $t("craftable-pro", "Replace") }}</Button>
                        ...
                        <button
                            type="button"
                            class="absolute top-2 right-3 rounded-full text-gray-500 dark:text-gray-300 hover:text-gray-700"
                            @click="removeImage(file)"
                        >
            ...
            <label
                ...
                :class="{
                    ...
                    'hover:border-primary-400 border-gray-300 dark:border-gray-500': !dropIsActive,
                }"
            ...
            >
                ...
                >
                    ...
                    >
                        <slot name="icon">
                            <DocumentPlusIcon class="h-10 w-10 stroke-1 text-gray-500 dark:text-gray-300" />
                        </slot>
