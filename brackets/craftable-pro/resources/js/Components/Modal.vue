<template>
    <div>
        ...
        <TransitionRoot
            as="template"
            :show="externalOpen ? props.open : open"
        >
            <Dialog
                as="div"
            ...
            >
                ...
                >
                    ...
                    >
                        <DialogOverlay
                            class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity dark:bg-gray-800 dark:bg-opacity-80"
                        />
                    </TransitionChild>
                    ...
                    >
                        <div
                            class="relative inline-block transform rounded-lg bg-white dark:bg-gray-700 px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:p-6 sm:align-middle"
                            :class="{
                                'sm:max-w-md': size === 'sm',
                                'sm:max-w-xl': size === 'md',
                        ...
                        >
                            ...
                            >
                                <div
                                    ...
                                    :class="{
                                        'bg-danger-100 dark:bg-danger-800': type === 'danger',
                                        'bg-success-100 dark:bg-success-800': type === 'success',
                                        'bg-info-100 dark:bg-info-800': type === 'info',
                                        'bg-warning-100 dark:bg-warning-800': type === 'warning',
                                    }"
                                >
                                ...
                                >
                                    <DialogTitle
                                        v-if="hasTitle"
                                        as="h3"
                                        class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-gray-100"
                                    >
                                        <slot name="title" />
                                    </DialogTitle>
