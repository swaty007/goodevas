<template>
  ...
  >
    <div class="relative flex rounded-md shadow-sm">
      <span
        v-if="leadingAddon"
        class="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-grey-800 px-3 text-gray-500 dark:text-gray-300 dark:text-gray-400 sm:text-sm"
      >
        {{ leadingAddon }}
      </span>
      ...
      <span
        v-if="trailingAddon"
        class="inline-flex items-center rounded-r-md border border-l-0 border-gray-300 dark:border-gray-600 bg-gray-50 px-3 text-gray-500 dark:text-gray-300 sm:text-sm"
      >
        {{ trailingAddon }}
      </span>
    </div>
