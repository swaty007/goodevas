...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    public $signature = 'craftable-pro:install      {--overwrite        : Overwrite files}
     ...
     * @var string
     */
    protected $assetsNamespace = 'craftable-pro';
    ...
    public function handle(): int
    {
        ...
        if (! $this->option('no-user')) {
            $this->call(
                'craftable-pro:create-admin-user',
                [
        ...
        $this->components->warn('Don\'t forget to execute the "npm install && npm run craftable-pro:dev" command to build newly published assets.');
    ...
    public function updateNodePackages(): void
    {
        $this->editPackageJson(function ($packages) {
            ...
            return [
                ...
                '@tiptap/extension-youtube' => '^2.0.0-beta.202',
