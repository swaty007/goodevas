...
namespace Brackets\CraftablePro\Http\Controllers\Media;

use Brackets\CraftablePro\Http\Requests\Media\IndexMedia;
use Brackets\CraftablePro\Http\Requests\Media\UpdateMedia;
...
class MediaController extends Controller
{
    ...
    public function updateMedia(Media $media, UpdateMedia $request)
    {
        ...
        return redirect()->back()->with(['message' => ___('craftable-pro', 'Media property updated')]);
    }
}
